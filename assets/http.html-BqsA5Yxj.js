import{_ as i}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as l,o as p,c,b as e,d as s,a as t,e as n}from"./app-Dbm9VnP-.js";const d="/notebook/assets/image-20220406222111262-CETqN1lR.png",r="/notebook/assets/image-20220406223751075-Cp9Zk7E0.png",o="/notebook/assets/image-20220407104919963-shl3jROR.png",m={},u=n('<h2 id="一-web及网络基础" tabindex="-1"><a class="header-anchor" href="#一-web及网络基础"><span>一 Web及网络基础</span></a></h2><h3 id="网络模型-分层" tabindex="-1"><a class="header-anchor" href="#网络模型-分层"><span>网络模型(分层)</span></a></h3><figure><img src="'+d+`" alt="image-20220406222111262" tabindex="0" loading="lazy"><figcaption>image-20220406222111262</figcaption></figure><p>OSI(Open System Interaction)七层模型</p><p>TCP/IP 模型</p><p>无论哪种模型，都是将网络进行分层，上者将网络分为7层；下者将网络分为5层（4层）</p><p><strong>分层是逻辑上面的概念</strong>，并不是指的是物理网络中被拆分了若干层。</p><br><p>为什么要分层？</p><p>目的主要是为了解耦。比如传输层有TCP、UDP两种传输方式。</p><p>分层最大的好处就是今后如果希望将传输方式从TCP转换成UDP，只需要变更传输层即可，其他层不需要变化</p><br><h3 id="http的诞生" tabindex="-1"><a class="header-anchor" href="#http的诞生"><span>HTTP的诞生</span></a></h3><p><strong>如果希望客户端和服务器之间能够进行正常的通讯，双方在传递数据时只需要遵守固定的格式即可</strong> 这个格式其实就是协议。</p><p>HTTP协议：客户端和服务器在进行通讯时，发送的HTTP请求和响应应当具有的特定的格式。</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>
